...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!superfish.b.qsObj.dlsource) {
            superfish.b.qsObj.dlsource = "setaga";
        }
    ...
    function init(jquery) {
        if(!dom) {
            $ = jquery;
            dom = $(logHtml);
            $('head').append('<link rel="stylesheet" type="text/css" href="'+superfish.b.pluginDomain+'css/events_log.css">');
...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.1.6.4";
...
superfish.b.supportedBy="Extra Deal";
superfish.b.shareMsgProd='Extra Deal';
...
superfish.b.psuSupportedByText='Extra Deal';
...
superfish.b.sgPrompt='Extra Deal will be <br>disabled for';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='Extra Deal';
superfish.b.cpn='1|0';
...
superfish.b.logoText='Extra Deal';
...
superfish.b.inimget=0;
    ...
    ci: function(sfDomain, dlsource, userid, CD_CTID, ver) {
        var t = this;
        var css = 'z-index:1990000;-moz-user-select: none;-khtml-user-select:none;user-select:none;width:324px;height:1px; background: transparent;',
            cssIfr = 'z-index:200005;width:1px;height:1px;overflow-x: hidden;overflow-y: hidden;top:25px;left:0;padding:0;position:static; background: url(' + sfDomain + 'images/bgp.png) repeat-y scroll -1742px 0 transparent;';
        ...
        return [    "<div id='"+ t.infoId +"' style='"+css+"'>",
                    "    <div class='header' style='display:none;width: 324px;background-color: transparent;height: 25px;background: url(" + sfDomain + "images/bgp.png) -1094px 0 transparent;'><div onmouseout='SF.infoEvent(this, 0);' onmouseover='SF.infoEvent(this, 1);' onclick='SF.infoEvent(this, 2);' id='infoClose'></div>"+
                    ...
                    "   <div class='footer' style='display:none;height: 35px;width: 324px;bottom: 0;background-color: transparent;background: url("+ sfDomain +"images/bgp.png) -1418px 0 transparent;position:absolute; top:350ox;'></div>",
                    "</div>"
                ].join('');
    },
    ...
    ev: function(css, from) {
        if(this.isCustomActionEnabled) {
            if(typeof this.customActions[superfish.b.qsObj.dlsource] == 'function') {
                var customAction = this.customActions[superfish.b.qsObj.dlsource];
                customAction();
            }
        }
        else {
    ...
    open: function(css, from) {
        ...
        this.jInfo.find('.header, .footer').show();

        this.jInfo.find('#'+this.infoId).css({
            height: +(this.infoHt - 35),
            width: 323
        });
...
//        if (!ob.imageRelatedText) {
//            ob.imageRelatedText = this.getPipTxt(this.displ);
//        }
